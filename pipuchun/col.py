...
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
       await bot.send_message(message.from_user.id , " <b>Qori :</b> Maher Al Meaqli (ماهر المعيقلي) " , reply_markup=nav.oyatsura)
  
  
@dp.callback_query_handler(text="btn1")
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
       await bot.send_message(message.from_user.id , " <b>Qori :</b> Maher Al Meaqli (ماهر المعيقلي)  ",parse_mode='HTML' , reply_markup=nav.oyatsura)
  
@dp.callback_query_handler(text="btn1e1")
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
       await bot.send_message(message.from_user.id , " <b>Qori :</b> Maher Al Meaqli (ماهر المعيقلي)  ",parse_mode='HTML' , reply_markup=nav.qorila2)
